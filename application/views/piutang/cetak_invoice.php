...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="page" style="width: 85%; margin: auto; padding-top: 80px">
        <table width="100%" id="atas">
            <tr>
                <td width=70%><img src="<?=base_url()?>/assets/img/tarq.png" width="260px"></td>
        ...
        <table width=100%  style="font-size: 9px">
            <tr>
                ...
                <td width=55% style="height: 30px; vertical-align: top">: <?= terbilang($total)?> rupiah</td>
            </tr>
            <tr>
                <td>Transfer via</td>
                ...
                <td rowspan=4>
                    <center>
                    <b>BENDAHARA TAR-Q</b><br><br><br><br><br>
