    ...
    <form action="<?= base_url()?>pendaftaran/add_privat" method="post">
        <div class="card" id="dataAkademik">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="status_kelas" id="status_kelas" class="form-control form-control-md" required>
                ...
                <div class="form-group">
                    ...
                    <select name="pengajar" id="pengajar" class='form-control form-control-md' required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="catatan" id="catatan" class="form-control form-control-md" required></textarea>
                ...
                <div class="d-flex justify-content-end">
                    <a href="#" class="btn btn-success btn-sm" id="nextDiri">Data Diri <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="card" id="dataDiri">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="#" class="btn btn-success btn-sm" id="nextAlamat">Data Alamat <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="card" id="dataAlamat">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-dark mb-1">Data Alamat</h6>
            </div>
            <div class="card-body">
                <div class="form-group">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="#" class="btn btn-success btn-sm" id="nextPekerjaan">Data Pekerjaan <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="card" id="dataPekerjaan">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-dark mb-1">Data Pekerjaan</h6>
            </div>
            <div class="card-body">
                <div class="form-group">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="#" class="btn btn-success btn-sm" id="nextOrtu">Data Ortu <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="card" id="dataOrtu">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-dark mb-1">Data Orang Tua</h6>
            </div>
            <div class="card-body">
                <div class="form-group">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-success btn-sm" id="tambah">Tambah Peserta</button>
                </div>
            </div>
        </div>
    </form>
