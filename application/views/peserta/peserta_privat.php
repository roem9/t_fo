<div class="modal fade" id="modalDetailPesertaPrivat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    ...
    var dataTable = $('#tableData').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: { url: `<?= base_url()?>peserta/getListPesertaPrivat/<?= $tipe?>/<?= $status?>`, type: "POST" },
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    return `
                        <a href="javascript:void(0)" class="modalDetailPesertaPrivat" data-bs-toggle="modal" data-bs-target="#modalDetailPesertaPrivat" data-id="${row['id_peserta']}">
