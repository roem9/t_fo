    ...
    <div class="card-body">
        <table id="tableData" class="table table-hover align-items-center mb-0 text-dark">
            <thead>
                ...
                <th class="text-uppercase text-dark text-xxs font-weight-bolder desktop">Ruangan</th>
                <th class="text-uppercase text-dark text-xxs font-weight-bolder all">Jadwal</th>
                <!-- <th class="text-uppercase text-dark text-xxs font-weight-bolder all">Hari</th>
...
<script>    
    ...
    var dataTable = $('#tableData').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: { url: `<?= base_url()?>kelas/getListKelasReguler`, type: "POST" },
        columns: [
            ...
            { data: "tempat", orderable: true, searchable: true, className: "text-sm w-1" },
            // { data: "hari", orderable: true, searchable: true, className: "text-sm text-wrap" },
            // { data: "jam", orderable: true, searchable: true, className: "text-sm text-wrap" },
            {
                data: "hari",
                orderable: true,
                searchable: true,
